...
filter_list_chunk['MAD-9D']['t1']   = np.array(filter_list_chunk['MAD-9D']['t1'])
filter_list_chunk['MAD-9D']['t2']   = np.array(filter_list_chunk['MAD-9D']['t2'])
filter_list_chunk['MAD-9D']['t3']   = np.array(filter_list_chunk['MAD-9D']['t3'])
filter_list_chunk['MAH-9D']['t1'] = np.array(filter_list_chunk['MAH-9D']['t1'])
filter_list_chunk['MAH-9D']['t2'] = np.array(filter_list_chunk['MAH-9D']['t2'])
filter_list_chunk['MAH-9D']['t3'] = np.array(filter_list_chunk['MAH-9D']['t3'])
...
# MAD 9D
print('MAD 9D')
print(pg.friedman(pd.DataFrame(filter_list['MAD-9D'])))
print(pg.wilcoxon(filter_list['MAD-9D']['t1'], filter_list['MAD-9D']['t2']))
print(pg.wilcoxon(filter_list['MAD-9D']['t1'], filter_list['MAD-9D']['t3']))
print(pg.wilcoxon(filter_list['MAD-9D']['t2'], filter_list['MAD-9D']['t3']))
print()

# MAH 9D
print('MAH 9D')
print(pg.friedman(pd.DataFrame(filter_list['MAH-9D'])))
print(pg.wilcoxon(filter_list['MAH-9D']['t1'], filter_list['MAH-9D']['t2']))
print(pg.wilcoxon(filter_list['MAH-9D']['t1'], filter_list['MAH-9D']['t3']))
print(pg.wilcoxon(filter_list['MAH-9D']['t2'], filter_list['MAH-9D']['t3']))
print()
...
print('MAD 9D')
print(np.median(filter_list['MAD-9D']['t1']))
print(np.median(filter_list['MAD-9D']['t2']))
print(np.median(filter_list['MAD-9D']['t3']))

print('MAH 9D')
print(np.median(filter_list['MAH-9D']['t1']))
print('MAH 9D t1 Q1:', np.percentile(filter_list['MAH-9D']['t1'], 25))
print('MAH 9D t1 Q3:', np.percentile(filter_list['MAH-9D']['t1'], 75))
print(np.median(filter_list['MAH-9D']['t2']))
print('MAH 9D t2 Q1:', np.percentile(filter_list['MAH-9D']['t2'], 25))
print('MAH 9D t2 Q3:', np.percentile(filter_list['MAH-9D']['t2'], 75))
print(np.median(filter_list['MAH-9D']['t3']))
print('MAH 9D t3 Q1:', np.percentile(filter_list['MAH-9D']['t3'], 25))
print('MAH 9D t3 Q3:', np.percentile(filter_list['MAH-9D']['t3'], 75))
...
plot_box(ax[0], filter_list['VQF-9D']['t1'], 1, color_mt, box_width, 0.5, side = 'right')
plot_density(ax[0], filter_list['VQF-9D']['t1'], 1 + box_width/2, color_mt, scale, covf, side = 'right')
plot_data_point(ax[0], filter_list['VQF-9D']['t1'], color_mt, position = 1.25)

plot_box(ax[0], filter_list['VQF-9D']['t2'], 2, color_mt, box_width, 0.5, side = 'right')
plot_density(ax[0], filter_list['VQF-9D']['t2'], 2 + box_width/2, color_mt, scale, covf, side = 'right')
plot_data_point(ax[0], filter_list['VQF-9D']['t2'], color_mt, position = 2.25)

plot_box(ax[0], filter_list['VQF-9D']['t3'], 3, color_mt, box_width, 0.5, side = 'right')
plot_density(ax[0], filter_list['VQF-9D']['t3'], 3 + box_width/2, color_mt, scale, covf, side = 'right')
plot_data_point(ax[0], filter_list['VQF-9D']['t3'], color_mt, position = 3.25)

ax[0].scatter(0.7, 37, color = color_mt, edgecolor = 'none', alpha = 0.5, s = 47, marker = 'v', zorder = 2)
ax[0].annotate('9D VQF', xy = (0.14, 0.95), xycoords = 'axes fraction', fontsize = 11, ha = 'left', va = 'top', color = color_mt)
...
ax[0].set_xticks([0.5, 1, 2, 3, 3.5])
ax[0].set_xticklabels(['', 'T1', 'T2', 'T3', ''])
ax[0].set_ylabel(r'Overall RMSD $(^o)$', fontsize = fontsize_label)


# MAD 9D
plot_box(ax[1], filter_list['MAD-9D']['t1'], 1, '#414535', box_width, 0.5, side = 'right')
plot_density(ax[1], filter_list['MAD-9D']['t1'], 1 + box_width/2, '#414535', scale, covf, side = 'right')
plot_data_point(ax[1], filter_list['MAD-9D']['t1'], '#414535', position = 1.25)

plot_box(ax[1], filter_list['MAD-9D']['t2'], 2, '#414535', box_width, 0.5, side = 'right')
plot_density(ax[1], filter_list['MAD-9D']['t2'], 2 + box_width/2, '#414535', scale, covf, side = 'right')
plot_data_point(ax[1], filter_list['MAD-9D']['t2'], '#414535', position = 2.25)

plot_box(ax[1], filter_list['MAD-9D']['t3'], 3, '#414535', box_width, 0.5, side = 'right')
plot_density(ax[1], filter_list['MAD-9D']['t3'], 3 + box_width/2, '#414535', scale, covf, side = 'right')
plot_data_point(ax[1], filter_list['MAD-9D']['t3'], '#414535', position = 3.25)

ax[1].scatter(0.7, 37, color = '#414535', edgecolor = 'none', alpha = 0.5, s = 100, marker = '*', zorder = 2)
ax[1].annotate('9D MAD', xy = (0.14, 0.95), xycoords = 'axes fraction', fontsize = 11, ha = 'left', va = 'top', color = '#414535')
...
ax[1].set_xticks([0.5, 1, 2, 3, 3.5])
ax[1].set_xticklabels(['', 'T1', 'T2', 'T3', ''])


# MAH 9D
plot_box(ax[2], filter_list['MAH-9D']['t1'], 1, '#82A7A6', box_width, 0.5, side = 'right')
plot_density(ax[2], filter_list['MAH-9D']['t1'], 1 + box_width/2, '#82A7A6', scale, covf, side = 'right')
plot_data_point(ax[2], filter_list['MAH-9D']['t1'], '#82A7A6', position = 1.25)

plot_box(ax[2], filter_list['MAH-9D']['t2'], 2, '#82A7A6', box_width, 0.5, side = 'right')
plot_density(ax[2], filter_list['MAH-9D']['t2'], 2 + box_width/2, '#82A7A6', scale, covf, side = 'right')
plot_data_point(ax[2], filter_list['MAH-9D']['t2'], '#82A7A6', position = 2.25)

plot_box(ax[2], filter_list['MAH-9D']['t3'], 3, '#82A7A6', box_width, 0.5, side = 'right')
plot_density(ax[2], filter_list['MAH-9D']['t3'], 3 + box_width/2, '#82A7A6', scale, covf, side = 'right')
plot_data_point(ax[2], filter_list['MAH-9D']['t3'], '#82A7A6', position = 3.25)

ax[2].scatter(0.7, 74, color = '#82A7A6', edgecolor = 'none', alpha = 0.5, s = 47, marker = 's', zorder = 2)
ax[2].annotate('9D MAH', xy = (0.14, 0.95), xycoords = 'axes fraction', fontsize = 11, ha = 'left', va = 'top', color = '#82A7A6')
...
# # MAD 9D
# plot_box(ax2, filter_list['MAD-9D']['t1'], 1, '#414535', box_width, 0.5, side = 'right')
# plot_density(ax2, filter_list['MAD-9D']['t1'], 1 + box_width/2, '#414535', scale + 0.4, covf, side = 'right')
# plot_data_point(ax2, filter_list['MAD-9D']['t1'], '#414535', position = 1.25)

# plot_box(ax2, filter_list['MAD-9D']['t2'], 2, '#414535', box_width, 0.5, side = 'right')
# plot_density(ax2, filter_list['MAD-9D']['t2'], 2 + box_width/2, '#414535', scale + 0.4, covf, side = 'right')
# plot_data_point(ax2, filter_list['MAD-9D']['t2'], '#414535', position = 2.25)

# plot_box(ax2, filter_list['MAD-9D']['t3'], 3, '#414535', box_width, 0.5, side = 'right')
# plot_density(ax2, filter_list['MAD-9D']['t3'], 3 + box_width/2, '#414535', scale + 0.4, covf, side = 'right')
# plot_data_point(ax2, filter_list['MAD-9D']['t3'], '#414535', position = 3.25)

# ax2.scatter(0.7, 37, color = '#414535', edgecolor = 'none', alpha = 0.5, s = 100, marker = '*', zorder = 2)
# ax2.annotate('9D MAD', xy = (0.14, 0.95), xycoords = 'axes fraction', fontsize = 11, ha = 'left', va = 'top', color = '#414535')
...
# # MAH 9D
# plot_box(ax3, filter_list['MAH-9D']['t1'], 1, '#82A7A6', box_width, 0.5, side = 'right')
# plot_density(ax3, filter_list['MAH-9D']['t1'], 1 + box_width/2, '#82A7A6', scale*20, covf, side = 'right')
# plot_data_point(ax3, filter_list['MAH-9D']['t1'], '#82A7A6', position = 1.25)

# plot_box(ax3, filter_list['MAH-9D']['t2'], 2, '#82A7A6', box_width, 0.5, side = 'right')
# plot_density(ax3, filter_list['MAH-9D']['t2'], 2 + box_width/2, '#82A7A6', scale*20, covf, side = 'right')
# plot_data_point(ax3, filter_list['MAH-9D']['t2'], '#82A7A6', position = 2.25)

# plot_box(ax3, filter_list['MAH-9D']['t3'], 3, '#82A7A6', box_width, 0.5, side = 'right')
# plot_density(ax3, filter_list['MAH-9D']['t3'], 3 + box_width/2, '#82A7A6', scale*20, covf, side = 'right')
# plot_data_point(ax3, filter_list['MAH-9D']['t3'], '#82A7A6', position = 3.25)

# ax3.scatter(0.7, 74, color = '#82A7A6', edgecolor = 'none', alpha = 0.5, s = 47, marker = 's', zorder = 2)
# ax3.annotate('9D MAH', xy = (0.14, 0.95), xycoords = 'axes fraction', fontsize = 11, ha = 'left', va = 'top', color = '#82A7A6')
...
# riann6d_t1_median                  = np.median(filter_list_chunk['MAD-9D']['t1'], axis = 0)
# riann6d_t1_lower, riann6d_t1_upper = get_whisker(filter_list_chunk['MAD-9D']['t1'])
# riann6d_t2_median                  = np.median(filter_list_chunk['MAD-9D']['t2'], axis = 0)
# riann6d_t2_lower, riann6d_t2_upper = get_whisker(filter_list_chunk['MAD-9D']['t2'])
# riann6d_t3_median                  = np.median(filter_list_chunk['MAD-9D']['t3'], axis = 0)
# riann6d_t3_lower, riann6d_t3_upper = get_whisker(filter_list_chunk['MAD-9D']['t3'])

# vqf6d_t1_median                = np.median(filter_list_chunk['MAH-9D']['t1'], axis = 0)
# vqf6d_t1_lower, vqf6d_t1_upper = get_whisker(filter_list_chunk['MAH-9D']['t1'])
# vqf6d_t2_median                = np.median(filter_list_chunk['MAH-9D']['t2'], axis = 0)
# vqf6d_t2_lower, vqf6d_t2_upper = get_whisker(filter_list_chunk['MAH-9D']['t2'])
# vqf6d_t3_median                = np.median(filter_list_chunk['MAH-9D']['t3'], axis = 0)
# vqf6d_t3_lower, vqf6d_t3_upper = get_whisker(filter_list_chunk['MAH-9D']['t3'])
...
# plt.savefig('imu_benchmark/plot/benchmark_f5_four_9d_filters.svg')
