...
def main():
    ...
    parser.add_argument('--enable_mocap_alignment', action = 'store_true') # align the data to the mocap data


    args = parser.parse_args()

    evaluate(args.subject, args.task, args.reference, args.enable_mocap_alignment, args.selected_setup, args.do_biomodel)
