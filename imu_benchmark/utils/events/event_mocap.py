...
def get_marker_traj(s_mocap_data):
    ...
    Args:
       + s_mocap_data (pd.DataFrame): mocap data of a subject

    Returns:
       + marker_traj_r (dict of np.array): marker trajectories of the right leg
       + marker_traj_l (dict of np.array): marker trajectories of the left leg
    '''
...
def ge_heel_toe_sacrum(marker_traj, fs):
    ...
    # print(gait_events['hc_index'][first_hc_id])
