...
def quat_to_euler(quat, to_deg = True):
    ...
    # angle_z = np.arctan2(2*quat[0]*quat[3] + 2*quat[1]*quat[2], 
    #                      1 - 2*quat[2]**2 - 2*quat[3]**2)
    # angle_y = np.arcsin(2*quat[0]*quat[2] - 2*quat[1]*quat[3])
    # # angle_y = np.arcsin(np.clip(2*quat[0]*quat[2] - 2*quat[1]*quat[3], -1.0, 1.0))
    # angle_x = np.arctan2(2*quat[0]*quat[1] + 2*quat[2]*quat[3], 
